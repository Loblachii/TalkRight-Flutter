...
class CourseOneLec5Exercise extends StatefulWidget {
  const CourseOneLec5Exercise({super.key});

  @override
  State<CourseOneLec5Exercise> createState() => _CourseOneLec5ExerciseState();
}

class _CourseOneLec5ExerciseState extends State<CourseOneLec5Exercise>
  ...
  final List<Map<String, dynamic>> allQuizData = [
    {
      'audio': 'flower',
      'options': [
        {'label': 'fr', 'sound': 'frConsonant.m4a'},
        {'label': 'sl', 'sound': 'slConsonant.m4a'},
        {'label': 'fl', 'sound': 'flConsonant.m4a'},
      ],
      'correctAnswer': 2,
    },
    {
      'audio': 'tree',
      'options': [
        {'label': 'tw', 'sound': 'twConsonant.m4a'},
        {'label': 'tr', 'sound': 'trConsonant.m4a'},
        {'label': 'dr', 'sound': 'drConsonant.m4a'},
      ],
      'correctAnswer': 1,
    },
    {
      'audio': 'blue',
      'options': [
        {'label': 'bl', 'sound': 'blConsonant.m4a'},
        {'label': 'br', 'sound': 'brConsonant.m4a'},
        {'label': 'gl', 'sound': 'glConsonant.m4a'},
      ],
      'correctAnswer': 0,
    },
    {
      'audio': 'snake',
      'options': [
        {'label': 'sm', 'sound': 'smConsonant.m4a'},
        {'label': 'st', 'sound': 'stConsonant.m4a'},
        {'label': 'sn', 'sound': 'snConsonant.m4a'},
      ],
      'correctAnswer': 2,
    },
    {
      'audio': 'star',
      'options': [
        {'label': 'sp', 'sound': 'spConsonant.m4a'},
        {'label': 'st', 'sound': 'stConsonant.m4a'},
        {'label': 'sw', 'sound': 'swConsonant.m4a'},
      ],
      'correctAnswer': 1,
    },
    {
      ...
      'options': [
        {'label': 'fr', 'sound': 'frConsonant.m4a'},
        {'label': 'fl', 'sound': 'flConsonant.m4a'},
        {'label': 'gr', 'sound': 'grConsonant.m4a'},
      ],
      'correctAnswer': 0,
    },
    {
      'audio': 'clock',
      'options': [
        {'label': 'cr', 'sound': 'crConsonant.m4a'},
        {'label': 'gl', 'sound': 'glConsonant.m4a'},
        {'label': 'cl', 'sound': 'clConsonant.m4a'},
      ],
      'correctAnswer': 2,
    },
    {
    ...
    },
    {
      ...
      'options': [
        {'label': 'br', 'sound': 'brConsonant.m4a'},
        {'label': 'bl', 'sound': 'blConsonant.m4a'},
        {'label': 'pr', 'sound': 'prConsonant.m4a'},
      ],
      'correctAnswer': 0,
    },
    {
  ...
  Future<void> _playOptionSoundThen(
    String soundFile,
    VoidCallback onDone,
  ) async {
    if (_disposed || !mounted) return;
    ...
    // Global onPlayerComplete in initState resets _isSoundPlaying,
    // so just poll until it's done
    _waitForSoundThen(onDone);
  }
  ...
  void selectAnswer(int index) {
    ...
    final String soundFile =
        (questionData['options'] as List<Map<String, dynamic>>)[index]['sound']
            as String;
    ...
    _playOptionSoundThen(soundFile, () {
      if (_disposed || !mounted) return;
  ...
  void _handleIncorrectFlow(
    ...
    _playFeedbackSound(false).then((_) {
      ...
      _waitForSoundThen(() async {
        ...
        final String correctSoundFile =
            (questionData['options']
                    as List<Map<String, dynamic>>)[correctIndex]['sound']
                as String;

        // ...inside _waitForSoundThen callback:
        _playOptionSoundThen(correctSoundFile, () {
          if (_disposed || !mounted) return;
          _advanceQuestion();
        });
      });
  ...
  Future<void> _saveProgress() async {
    ...
    if (!wasCompleted &&
        _progressManager.isLessonFullyCompleted('course_one', 4)) {
