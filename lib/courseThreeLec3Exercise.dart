...
class CourseThreeLec3Exercise extends StatefulWidget {
  const CourseThreeLec3Exercise({super.key});

  @override
  State<CourseThreeLec3Exercise> createState() =>
      _CourseThreeLec3ExerciseState();
}

class _CourseThreeLec3ExerciseState extends State<CourseThreeLec3Exercise>
  ...
  static const String _supportingText = 'Tap the phrase you hear.';

  // ── 10 text-choice questions ──────────────────────────────────────────────
  final List<Map<String, dynamic>> allQuizData = [
    // Q1 – correct index 1
    {
      'audioSentence': 'Good morning.',
      'answers': ['Good night', 'Good morning', 'Good afternoon'],
      'correctAnswer': 1,
    },
    // Q2 – correct index 1
    {
      'audioSentence': 'Hello!',
      'answers': ['Goodbye', 'Hello', 'Thank you'],
      'correctAnswer': 1,
    },
    // Q3 – correct index 1
    {
      'audioSentence': 'May I go out?',
      'answers': ['May I sit down?', 'May I go out?', 'Can you help me?'],
      'correctAnswer': 1,
    },
    // Q4 – correct index 0
    {
      'audioSentence': 'Please help me.',
      'answers': ['Please help me.', 'Help yourself.', 'Thank you.'],
      'correctAnswer': 0,
    },
    // Q5 – correct index 1
    {
      'audioSentence': 'Excuse me.',
      'answers': ['I\'m sorry.', 'Excuse me.', 'Goodbye.'],
      'correctAnswer': 1,
    },
    // Q6 – correct index 0
    {
      'audioSentence': 'Thank you.',
      'answers': ['Thank you.', 'You\'re welcome.', 'Sorry.'],
      'correctAnswer': 0,
    },
    // Q7 – correct index 0
    {
      'audioSentence': 'See you tomorrow.',
      'answers': ['See you tomorrow.', 'See you later.', 'Good morning.'],
      'correctAnswer': 0,
    },
    // Q8 – correct index 0
    {
      'audioSentence': 'I\'m sorry.',
      'answers': ['I\'m sorry.', 'I\'m happy.', 'I\'m ready.'],
      'correctAnswer': 0,
    },
    // Q9 – correct index 2
    {
      'audioSentence': 'Can you repeat that?',
      'answers': [
        'Can you read that?',
        'Can you open that?',
        'Can you repeat that?',
    ...
    // Q10 – correct index 2
    {
      'audioSentence': 'You\'re welcome.',
      'answers': ['Thank you.', 'Excuse me.', 'You\'re welcome.'],
      'correctAnswer': 2,
    },
  ];
  ...
  Future<void> _initializeTts() async {
    try {
      ...
      // _playOnQuestionLoad overrides this with a one-shot handler when needed.
  ...
  Future<void> _playOnQuestionLoad() async {
    ...
    try {
      ...
      // One-shot: after supporting text finishes, restore default handler
      // then speak the sentence (so sentence completion only releases lock).
      _flutterTts.setCompletionHandler(() {
        if (_disposed || !mounted) return;
        _flutterTts.setCompletionHandler(() {
          if (!_disposed && mounted) setState(() => _isSoundPlaying = false);
  ...
  _AnswerTileStyle _tileStyle(int index, int correctIndex) {
    ...
    if (_showWrongHighlight) {
      if (index == selectedAnswerIndex) {
        return _AnswerTileStyle(
          ...
          shadowColor: const Color(0xFFE53935).withOpacity(0.20),
          shadowBlur: 10,
        );
      }
      return _AnswerTileStyle(
    ...
    if (_showCorrectHighlight && index == correctIndex) {
      return _AnswerTileStyle(
    ...
    if (_lastAnswerCorrect == false && index == selectedAnswerIndex) {
      return _AnswerTileStyle(
        background: const Color(0xFFFFEBEE),
        borderColor: const Color(0xFFE53935),
        borderWidth: 2.5,
  ...
  Future<void> _saveProgress() async {
    ...
    if (!wasCompleted &&
        _progressManager.isLessonFullyCompleted('course_three', 2)) {
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      isCorrect
                          ? 'Great job identifying that phrase!'
