...
import 'dart:async';
import 'courseTwoLec6Exercise.dart';
import 'progress_manager.dart';
import 'settings_manager.dart';
import 'notification_helper.dart';

class CourseTwoLec6 extends StatefulWidget {
  final bool showModal;
  const CourseTwoLec6({super.key, this.showModal = false});
  @override
  State<CourseTwoLec6> createState() => _CourseTwoLec6State();
}

class _CourseTwoLec6State extends State<CourseTwoLec6>
  ...
  void _navigateToExercise() async {
    ...
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => const CourseTwoLec6Exercise(),
          ),
        )
        .then((result) async {
          await _flutterTts.stop();
                                        ...
                                        GestureDetector(
                                          ...
                                          child: PageView(
                                            ...
                                            children: [
                                              ...
                                              _buildBaseVsModified(),
                                              _buildStressChange(),
                                              _buildListeningAwareness(),
                                            ],
                                          ),
                                        ),
      ...
      child: Column(
        ...
        children: [
          Expanded(
            child: Center(
              child: Image.asset(
                'assets/images/stage2Lesson6.png',
                fit: BoxFit.contain,
                errorBuilder:
                    (_, __, ___) =>
  ...
  // ─── Helper: responsive orange word button ────────────────────────────────
  Widget _buildWordButton({
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final double fontSize = (size.width * 0.055).clamp(16.0, 24.0);
        final double hPad = (size.width * 0.065).clamp(14.0, 38.0);
        final double vPad = (size.height * 0.014).clamp(8.0, 18.0);
  ...
  // ─── Page 2: Base vs Modified Word — play | playing ──────────────────────
  Widget _buildBaseVsModified() {
    return LayoutBuilder(
      builder: (context, constraints) {
                ...
                child: Center(
                  child: Row(
                    ...
                    children: [
                      _buildWordButton(
                        label: 'play',
                        onTap: () => _speakWord('play'),
                      ),
                      SizedBox(width: spacing * 2),
                      _buildWordButton(
                        label: 'playing',
                        onTap: () => _speakWord('playing'),
                      ),
                    ],
                  ),
                ),
  ...
  // ─── Page 3: Stress Change — help | helpful ───────────────────────────────
  Widget _buildStressChange() {
    return LayoutBuilder(
      builder: (context, constraints) {
        final double h = constraints.maxHeight;
        final double captionSize = (h * 0.05).clamp(12.0, 18.0);
                ...
                child: Center(
                  child: Row(
                    ...
                    children: [
                      _buildWordButton(
                        label: 'help',
                        onTap: () => _speakWord('help'),
                      ),
                      SizedBox(width: spacing * 2),
                      _buildWordButton(
                        label: 'helpful',
                        onTap: () => _speakWord('helpful'),
                      ),
                    ],
                  ),
                ),
  ...
  // ─── Page 4: Listening Awareness — help | helpful (SLOW) ─────────────────
  Widget _buildListeningAwareness() {
    return LayoutBuilder(
      builder: (context, constraints) {
        final double h = constraints.maxHeight;
                ...
                child: Center(
                  child: Row(
                    ...
                    children: [
                      _buildWordButton(
                        label: 'help',
                        onTap: () => _speakWordSlow('help'),
                      ),
                      SizedBox(width: spacing * 2),
                      _buildWordButton(
                        label: 'helpful',
                        onTap: () => _speakWordSlow('helpful'),
                      ),
                    ],
                  ),
                ),
