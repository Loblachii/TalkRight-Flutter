...
class CourseThreeLec5Exercise extends StatefulWidget {
  const CourseThreeLec5Exercise({super.key});

  @override
  State<CourseThreeLec5Exercise> createState() =>
      _CourseThreeLec5ExerciseState();
}

class _CourseThreeLec5ExerciseState extends State<CourseThreeLec5Exercise>
  ...
  final List<Map<String, dynamic>> allQuizData = [
    // Q1 – correct index 1
    {
      'audioSentence': "I'm gonna go now.",
      'answers': ['I am going to go now.', "I'm gonna go now.", 'I go now.'],
      'correctAnswer': 1,
    },
    // Q2 – correct index 1
    {
      'audioSentence': 'Pick it up.',
      'answers': ['Pick up it.', 'Pick it up.', 'Pick up.'],
      'correctAnswer': 1,
    },
    // Q3 – correct index 0
    {
      'audioSentence': 'I wanna eat.',
      'answers': ['I wanna eat.', 'I want to eat.', 'I want eat.'],
      'correctAnswer': 0,
    },
    // Q4 – correct index 2
    {
      'audioSentence': "Let's go out.",
      'answers': ['Let go out.', 'Let us go out.', "Let's go out."],
      'correctAnswer': 2,
    },
    // Q5 – correct index 0
    {
      'audioSentence': 'Did you see it?',
      'answers': ['Did you see it?', 'Did you see?', 'Do you see it?'],
      'correctAnswer': 0,
    },
    // Q6 – correct index 1
    {
      'audioSentence': 'What are you doing?',
      'answers': [
        'What you doing?',
        'What are you doing?',
        'Where are you doing?',
    ...
    // Q7 – correct index 0
    {
      'audioSentence': 'Turn it off.',
      'answers': ['Turn it off.', 'Turn off it.', 'Turn it up.'],
      'correctAnswer': 0,
    },
    // Q8 – correct index 2
    {
      'audioSentence': 'I have to go.',
      'answers': ['I have go.', 'I had to go.', 'I have to go.'],
      'correctAnswer': 2,
    },
    // Q9 – correct index 0
    {
      'audioSentence': 'Give me a minute.',
      'answers': ['Give me a minute.', 'Give a minute.', 'Give me minute.'],
      'correctAnswer': 0,
    },
    // Q10 – correct index 2
    {
      'audioSentence': 'Can I help you?',
      'answers': ['Can help you?', 'Could I help you?', 'Can I help you?'],
      'correctAnswer': 2,
    },
  ];
  ...
  Future<void> _saveProgress() async {
    ...
    if (!wasCompleted &&
        _progressManager.isLessonFullyCompleted('course_three', 4)) {
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      isCorrect
                          ? 'Great job identifying that sentence!'
