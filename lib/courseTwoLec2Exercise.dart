...
class CourseTwoLec2Exercise extends StatefulWidget {
  const CourseTwoLec2Exercise({super.key});

  @override
  State<CourseTwoLec2Exercise> createState() => _CourseTwoLec2ExerciseState();
}

class _CourseTwoLec2ExerciseState extends State<CourseTwoLec2Exercise>
  ...
  final List<Map<String, dynamic>> allQuizData = [
    {
      'audio': 'feet',
      'options': [
        {'label': 'oo', 'sound': 'oo1VowelTeam.m4a'},
        {'label': 'ie', 'sound': 'ieVowelTeam.m4a'},
        {'label': 'ee', 'sound': 'eaVowelTeam.m4a'},
      ],
      'correctAnswer': 2,
    },
    {
      'audio': 'boat',
      'options': [
        {'label': 'ea', 'sound': 'iSound.m4a'},
        {'label': 'oa', 'sound': 'oaVowelTeam.m4a'},
        {'label': 'oo', 'sound': 'ooVowelTeam.m4a'},
      ],
      'correctAnswer': 1,
    },
    {
      ...
      'options': [
        {'label': 'oa', 'sound': 'oaVowelTeam.m4a'},
        {'label': 'oo', 'sound': 'oo1VowelTeam.m4a'},
        {'label': 'ue', 'sound': 'ueVowelTeam.m4a'},
      ],
      'correctAnswer': 1,
    },
    {
    ...
    },
    {
      ...
      'options': [
        {'label': 'oo', 'sound': 'ooVowelTeam.m4a'},
        {'label': 'oa', 'sound': 'oaVowelTeam.m4a'},
        {'label': 'ue', 'sound': 'u_eVowelTeam.m4a'},
      ],
      'correctAnswer': 2,
    },
    {
  ...
  Future<void> _playQuestionAudio() async {
    ...
    final String word =
        currentQuizQuestions[currentQuestion - 1]['audio'] as String;
  ...
  void selectAnswer(int index) {
    ...
    final String selectedSound = options[index]['sound'] as String;
  ...
  void _handleIncorrectFlow(
    ...
    final options = questionData['options'] as List<Map<String, dynamic>>;
    final String correctSound = options[correctIndex]['sound'] as String;
  ...
  Future<void> _saveProgress() async {
    ...
    if (!wasCompleted &&
        _progressManager.isLessonFullyCompleted('course_two', 1)) {
