...
class CourseThreeLec2Exercise extends StatefulWidget {
  const CourseThreeLec2Exercise({super.key});

  @override
  State<CourseThreeLec2Exercise> createState() =>
      _CourseThreeLec2ExerciseState();
}

class _CourseThreeLec2ExerciseState extends State<CourseThreeLec2Exercise>
  ...
  static const String _supportingText = 'Tap the word group you hear.';

  // ── 10 text-choice questions ──────────────────────────────────────────────
  final List<Map<String, dynamic>> allQuizData = [
    {
      'audioSentence': 'The big dog.',
      'answers': ['The big dog', 'is running fast'],
      'correctAnswer': 0,
    },
    {
      'audioSentence': 'is running fast.',
      'answers': ['The big dog', 'is running fast'],
      'correctAnswer': 1,
    },
    {
      'audioSentence': 'The small cat.',
      'answers': ['The small cat', 'is sleeping'],
      'correctAnswer': 0,
    },
    {
      'audioSentence': 'is sleeping.',
      'answers': ['The small cat', 'is sleeping'],
      'correctAnswer': 1,
    },
    {
      'audioSentence': 'The happy boy.',
      'answers': ['The happy boy', 'is jumping high'],
      'correctAnswer': 0,
    },
    {
      'audioSentence': 'is jumping high.',
      'answers': ['The happy boy', 'is jumping high'],
      'correctAnswer': 1,
    },
    {
      'audioSentence': 'The brown horse.',
      'answers': ['The brown horse', 'is walking slowly'],
      'correctAnswer': 0,
    },
    {
      'audioSentence': 'is walking slowly.',
      'answers': ['The brown horse', 'is walking slowly'],
      'correctAnswer': 1,
    },
    {
      'audioSentence': 'The big dog is running fast.',
      'answers': [
        'The big dog',
        'is running fast',
    ...
    {
      'audioSentence': 'The small cat is sleeping.',
      'answers': ['The small cat', 'is sleeping', 'The small cat is sleeping'],
      'correctAnswer': 2,
    },
  ];
  ...
  Future<void> _saveProgress() async {
    ...
    if (!wasCompleted &&
        _progressManager.isLessonFullyCompleted('course_three', 1)) {
