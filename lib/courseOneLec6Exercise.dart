...
class CourseOneLec6Exercise extends StatefulWidget {
  const CourseOneLec6Exercise({super.key});

  @override
  State<CourseOneLec6Exercise> createState() => _CourseOneLec6ExerciseState();
}

class _CourseOneLec6ExerciseState extends State<CourseOneLec6Exercise>
  ...
  final List<Map<String, dynamic>> allQuizData = [
    {
      'audio': 'hand',
      'options': [
        {'label': 'nd', 'sound': 'ndConsonantEnd.m4a'},
        {'label': 'nt', 'sound': 'ntConsonantEnd.m4a'},
        {'label': 'mp', 'sound': 'mpConsonantEnd.m4a'},
      ],
      'correctAnswer': 0,
    },
    {
      ...
      'options': [
        {'label': 'mp', 'sound': 'mpConsonantEnd.m4a'},
        {'label': 'lm', 'sound': 'lmConsonantEnd.m4a'},
        {'label': 'lp', 'sound': 'lpConsonantEnd.m4a'},
      ],
      'correctAnswer': 0,
    },
    {
      'audio': 'milk',
      'options': [
        {'label': 'lk', 'sound': 'lkConsonantEnd.m4a'},
        {'label': 'nd', 'sound': 'ndConsonantEnd.m4a'},
        {'label': 'nt', 'sound': 'ntConsonantEnd.m4a'},
      ],
      'correctAnswer': 0,
    },
    {
      'audio': 'nest',
      'options': [
        {'label': 'st', 'sound': 'stConsonantEnd.m4a'},
        {'label': 'nt', 'sound': 'ntConsonantEnd.m4a'},
        {'label': 'nd', 'sound': 'ndConsonantEnd.m4a'},
      ],
      'correctAnswer': 0,
    },
    {
      ...
      'options': [
        {'label': 'nd', 'sound': 'ndConsonantEnd.m4a'},
        {'label': 'mp', 'sound': 'mpConsonantEnd.m4a'},
        {'label': 'nk', 'sound': 'nkConsonantEnd.m4a'},
      ],
      'correctAnswer': 0,
    },
    {
      'audio': 'gift',
      'options': [
        {'label': 'ft', 'sound': 'ftConsonantEnd.m4a'},
        {'label': 'pt', 'sound': 'ptConsonantEnd.m4a'},
        {'label': 'st', 'sound': 'stConsonantEnd.m4a'},
      ],
      'correctAnswer': 0,
    },
    {
      'audio': 'mask',
      'options': [
        {'label': 'sk', 'sound': 'skConsonantEnd.m4a'},
        {'label': 'nd', 'sound': 'ndConsonantEnd.m4a'},
        {'label': 'st', 'sound': 'stConsonantEnd.m4a'},
      ],
      'correctAnswer': 0,
  ...
  Future<void> _saveProgress() async {
    ...
    if (!wasCompleted &&
        _progressManager.isLessonFullyCompleted('course_one', 5)) {
